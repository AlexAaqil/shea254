            ...
            <div class="custom_form">
                ...
                <form action="" method="post">
                    ...
                    <div class="input_group">
                        ...
                        <input type="text" name="town_name" id="town_name" value="{{ old('town_name', $town->town_name) }}" required />
                        <span class="inline_alert">{{ $errors->first('town_name') }}</span>
                    </div>

                    <div class="input_group">
                        <label for="price">Price</label>
                        <input type="number" name="price" id="price" value="{{ old('price', $town->price) }}" required />
